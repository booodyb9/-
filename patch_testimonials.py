...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#0ea5e9]/5 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#0ea5e9]/5 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-[#0ea5e9] text-sm font-bold tracking-widest uppercase mb-4">آراء العملاء</h2>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-12 pb-12">
          ...
          >
            {testimonials.map((testimonial, index) => (
              <SwiperSlide key={index} className="h-auto pb-4">
                ...
                >
                  <Quote className="absolute top-8 right-8 h-10 w-10 text-[#0ea5e9]/10 group-hover:text-[#0ea5e9]/20 transition-colors duration-500 transform group-hover:scale-110" />
          ...
          <button className="swiper-button-prev-test absolute top-1/2 -left-2 md:-left-6 -translate-y-1/2 z-10 bg-white border border-gray-100 shadow-xl p-3 rounded-full text-[#0ea5e9] hover:bg-[#0ea5e9] hover:text-white transition-all hidden sm:flex">
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button className="swiper-button-next-test absolute top-1/2 -right-2 md:-right-6 -translate-y-1/2 z-10 bg-white border border-gray-100 shadow-xl p-3 rounded-full text-[#0ea5e9] hover:bg-[#0ea5e9] hover:text-white transition-all hidden sm:flex">
