            ...
            {heroContent?.body ? (
              ...
              <>
                <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl lg:text-[5rem] font-bold text-white leading-[1.05] tracking-tight mb-8">
                  {language === 'ar' ? (
                    <>أرقى أعمال <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#38bdf8] italic pr-2">الزجاج الحديث</span></>
                  ) : (
                    <>Premium <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#38bdf8] italic">Modern Glass</span></>
                  )}
                </motion.h1>
