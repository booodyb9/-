...
# I will replace the location string with an embedded map below it, or append it below the contact info block.
...
content = content.replace("          </motion.div>", map_html)

with open('src/components/Contact.tsx', 'w') as f:
    f.write(content)

print("Contact.tsx updated with Map")
