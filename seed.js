...
var config = JSON.parse(fs.readFileSync('./firebase-applet-config.json', 'utf8'));
...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, defaultProjects_1, proj, id, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Seeding data...');
                    _i = 0, defaultProjects_1 = defaultProjects;
                    _a.label = 1;
                case 1:
                    if (!(_i < defaultProjects_1.length)) return [3 /*break*/, 4];
                    proj = defaultProjects_1[_i];
                    id = proj.id, data = __rest(proj, ["id"]);
                    return [4 /*yield*/, (0, firestore_1.setDoc)((0, firestore_1.doc)(db, 'projects', id), data)];
                case 2:
                    _a.sent();
                    console.log("Added ".concat(id));
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
