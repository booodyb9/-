...
import { X, Search, ChevronRight, ChevronLeft, MapPin, Briefcase, ArrowUpRight, ZoomIn } from 'lucide-react';
                ...
                <SwiperSlide key={project.id} className="h-auto pb-4">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col justify-end h-full p-6 text-white translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                      ...
                      <div className="flex items-center gap-2 text-[#0ea5e9] font-bold mt-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200">
                        عرض التفاصيل
        ...
        {lightboxIndex !== null && currentLightboxProject && (
          ...
          >
            ...
            <div className="max-w-6xl w-full mx-4 flex flex-col md:flex-row gap-8 items-center justify-center h-full py-20 outline-none">
              ...
              >
                <div>
                  <span className="text-[#0ea5e9] text-sm font-bold tracking-widest uppercase mb-2 block">
                ...
                <Link
                  ...
                  className="mt-8 inline-flex items-center gap-2 bg-[#0ea5e9] hover:bg-[#38bdf8] text-white px-8 py-4 rounded-full font-bold transition-colors w-full justify-center group"
                >
