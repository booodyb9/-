      ...
      <nav id="nav" className={isScrolled ? 'scrolled' : ''}>
        <div className="nav-inner">
          ...
          <ul className="nav-links">
            <li><a href="#services" onClick={(e) => { e.preventDefault(); scrollTo('services'); }}>خدماتنا</a></li>
            <li><a href="#gallery" onClick={(e) => { e.preventDefault(); scrollTo('gallery'); }}>أعمالنا</a></li>
            ...
            <li><a href="#faq" onClick={(e) => { e.preventDefault(); scrollTo('faq'); }}>الأسئلة الشائعة</a></li>
            <li><a href="#contact" className="btn nav-cta" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>
        ...
        <div className={`mobile-nav ${isMobileNavOpen ? 'open' : ''}`}>
          <a href="#services" onClick={(e) => { e.preventDefault(); scrollTo('services'); }}>خدماتنا</a>
          <a href="#gallery" onClick={(e) => { e.preventDefault(); scrollTo('gallery'); }}>معرض الأعمال</a>
          ...
          <a href="#contact" className="nav-cta-mobile" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>اطلب تسعيرة مجانية</a>
        </div>
      </nav>
        ...
        <div className="hero-inner">
          <div className="hero-content">
            <div className="eyebrow reveal">
              ...
              الشركة الرائدة في الرياض منذ 2009
            </div>

            <h1 className="hero-h1 reveal reveal-delay-1">
              نصنع واجهات<br/>
              <span className="accent">زجاجية استثنائية</span><br/>
              تدوم عقوداً
            </h1>

            <p className="hero-lead reveal reveal-delay-2">
              حلول زجاجية متكاملة للمشاريع التجارية والسكنية في الرياض — واجهات، قواطع، كبائن شاور، ومرايا. جودة عالمية بأيدٍ سعودية محترفة.
            </p>
            ...
            <div className="hero-actions reveal reveal-delay-3">
              ...
              <a href="#gallery" className="btn btn-secondary" onClick={(e) => { e.preventDefault(); scrollTo('gallery'); }}>
            ...
            <div className="hero-trust reveal reveal-delay-4">
              ...
              <div className="trust-item">
                ...
                تنفيذ في الموعد دائماً
              </div>
              <div className="trust-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>
                فريق مرخّص ومعتمد
              </div>
            </div>
          </div>
          ...
          <div className="hero-visual reveal reveal-delay-2">
            <div className="glass-card-main">
              <div className="glass-card-main-bg">
                <div className="glass-card-inner-img">
                  <img src="https://media.architecturaldigest.com/photos/567899b37fd9a58978b7c39e/4:3/w_2000,h_1500,c_limit/innovative-glass-buildings-01.jpg" alt="واجهة زجاجية تجارية" />
                </div>
                <div className="glass-card-label">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{width:16,height:16,color:'var(--glass-500)'}}><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                  واجهة زجاجية تجارية — الرياض
                </div>
              </div>
            </div>

            <div className="float-badge badge-projects glass-morph">
              <div className="b-icon" style={{background:'rgba(43,139,191,0.1)'}}>🏗️</div>
              <div>
                <div className="b-label">+500</div>
                <div className="b-sub">مشروع منجز</div>
              </div>
            </div>

            <div className="float-badge badge-years glass-morph">
              <div className="b-icon" style={{background:'rgba(201,162,39,0.1)'}}>⭐</div>
              <div>
                <div className="b-label">15+ سنة</div>
                <div className="b-sub">من الخبرة</div>
              </div>
            </div>

            <div className="float-badge badge-rating glass-morph">
              <div className="b-icon" style={{background:'rgba(34,197,94,0.1)'}}>✅</div>
              <div>
                <div className="b-label"><span className="stars">★★★★★</span></div>
                <div className="b-sub">100% رضا العملاء</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="why-inner container">
          ...
          <div className="why-image reveal reveal-delay-2">
            <div className="why-img-card">
              <img src="https://images.stockcake.com/public/4/6/3/463ccf5d-b90d-4323-b34b-642ce5f2261c_large/luminous-glass-architecture-stockcake.jpg" alt="أعمال زجاجية فاخرة" />
          ...
          <div className="gallery-grid reveal">
            {[
              ...
              <div key={i} className={`gallery-item ${g.span}`} style={{ display: (activeFilter === 'all' || activeFilter === g.cat) ? 'block' : 'none' }}>
                <img className="gallery-img" src={g.img} alt={g.title} />
        ...
        <div className="footer-inner">
          ...
          <div>
            ...
            <ul className="footer-links">
              <li><Link to="/services">الواجهات الزجاجية</Link></li>
              <li><Link to="/services">القواطع المكتبية</Link></li>
              <li><Link to="/services">كبائن الشاور</Link></li>
              <li><Link to="/services">الأبواب الزجاجية</Link></li>
              <li><Link to="/services">المرايا الديكورية</Link></li>
              <li><Link to="/services">الدرابزين الزجاجي</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li style={{marginTop:16}}><Link to="/privacy">سياسة الخصوصية</Link></li>
...
print("Home.tsx updated with new design")
