  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="text-sm text-gray-500">آخر تحديث: منذ 5 دقائق</div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="إجمالي الزيارات" value="24,593" trend="+12.5%" isUp={true} icon={Eye} color="text-blue-600" bg="bg-blue-50" />
        <StatCard title="رسائل جديدة" value="15" trend="+5.2%" isUp={true} icon={MessageSquare} color="text-green-600" bg="bg-green-50" />
        <StatCard title="الصفحات النشطة" value="42" trend="-1.1%" isUp={false} icon={FileText} color="text-purple-600" bg="bg-purple-50" />
        <StatCard title="الوسائط المرفوعة" value="1,204" trend="+18.2%" isUp={true} icon={Image} color="text-orange-600" bg="bg-orange-50" />
      </div>
