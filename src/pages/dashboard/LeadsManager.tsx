    ...
    <div className="space-y-4" dir="rtl">
      ...
      {selected && <div className="fixed inset-0 z-[100] bg-black/50 flex items-end sm:items-center justify-center p-4" onClick={() => setSelected(null)}>
        <div className="bg-white rounded-2xl w-full max-w-xl p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="bg-gray-50 rounded-xl p-3 text-sm"><div><b>المصدر:</b> {selected.source}</div><div><b>درجة الاهتمام:</b> {selected.score} ({selected.temperature})</div><div><b>الرسالة:</b> {selected.message || '—'}</div></div>
