...
const defaultServices = [
  {
    ...
    image: 'https://ugvdoabczcnxluzxehga.supabase.co/storage/v1/object/public/media/516d5831-d7a5-4cf4-aee2-83774df3f590.jpg'
  },
  {
    icon: 'LayoutGrid',
    ...
    image: 'https://ugvdoabczcnxluzxehga.supabase.co/storage/v1/object/public/media/47c05967-1abd-4b26-900a-f0c97e88ce2b.jpg'
  },
  {
    icon: 'Home',
  ...
  },
  {
    ...
    image: 'https://ugvdoabczcnxluzxehga.supabase.co/storage/v1/object/public/media/portfolio/covers/4f1aa8fe-6836-431f-92a6-00c06985a988.webp'
  },
  {
    icon: 'Maximize',
  ...
  },
  {
    ...
    image: 'https://ugvdoabczcnxluzxehga.supabase.co/storage/v1/object/public/media/e9fd27f9-f786-474c-af76-2021bc8db88d.png'
  }
];
              ...
              <div className="p-8 flex flex-col flex-grow bg-white">
                ...
                <div className="mt-auto flex flex-col sm:flex-row gap-3">
                  <Link
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 bg-gray-50/80 backdrop-blur-md border border-gray-200/50 hover:bg-gray-100 hover:border-gray-300 text-[#0F172A] px-5 py-3 text-sm font-bold rounded-full transition-all group/btn"
                  >
                    التفاصيل
