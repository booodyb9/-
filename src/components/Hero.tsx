        ...
        <div className="max-w-3xl">
          <motion.div initial="hidden" animate="visible" variants={containerVariants}>
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row flex-wrap gap-4 mt-8">
              <a href="#services" className="group relative flex items-center justify-center gap-3 bg-white text-black px-8 py-4 font-bold text-base overflow-hidden rounded-md hover:text-white transition-colors duration-300">
              ...
              <a href="https://wa.me/966510233706" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center gap-2 bg-[#25D366] text-white px-8 py-4 font-bold text-base rounded-md hover:bg-[#1DA851] transition-colors duration-300 shadow-lg shadow-[#25D366]/20">
              ...
              <a href="tel:+966510233706" className="group flex items-center justify-center gap-2 bg-[#0284C7] text-white px-8 py-4 font-bold text-base rounded-md hover:bg-[#0369A1] transition-colors duration-300 shadow-lg shadow-[#0284C7]/20">
